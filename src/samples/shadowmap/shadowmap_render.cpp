...
void SimpleShadowmapRender::AllocateResources()
{
  ...
  {
    .extent = vk::Extent3D{m_width * m_ssaaScale, m_height * m_ssaaScale, 1},
  ...
  {
    .extent = vk::Extent3D{2048 * m_ssaaScale, 2048 * m_ssaaScale, 1},
    .name = "shadow_map",
...
void SimpleShadowmapRender::loadShaders()
{
  ...
  etna::create_program("downsample", {VK_GRAPHICS_BASIC_ROOT"/resources/shaders/quad.frag.spv",
                                  VK_GRAPHICS_BASIC_ROOT"/resources/shaders/quad3_vert.vert.spv"});
}
...
void SimpleShadowmapRender::SetupSimplePipeline()
{
  ...
  m_downsamplePipeline = pipelineManager.createGraphicsPipeline("downsample",
    {
...
void SimpleShadowmapRender::BuildCommandBufferSimple(VkCommandBuffer a_cmdBuff, VkImage a_targetImage, VkImageView a_targetImageView)
{
  ...
  //
  {
    etna::RenderTargetState renderTargets(a_cmdBuff, {2048 * m_ssaaScale, 2048 * m_ssaaScale}, {}, shadowMap);
  ...
  //
  {
    ...
    etna::RenderTargetState renderTargets(a_cmdBuff, {m_width * m_ssaaScale, m_height * m_ssaaScale}, {{supersampledImage}}, mainViewDepth);
  ...
  {
    auto outputInfo = etna::get_shader_program("downsample");
    ...
    vkCmdBindPipeline(a_cmdBuff, VK_PIPELINE_BIND_POINT_GRAPHICS, m_downsamplePipeline.getVkPipeline());
    vkCmdBindDescriptorSets(a_cmdBuff, VK_PIPELINE_BIND_POINT_GRAPHICS,
      m_downsamplePipeline.getVkPipelineLayout(), 0, 1, &vkSet, 0, VK_NULL_HANDLE);
