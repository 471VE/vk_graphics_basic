...
void SimpleShadowmapRender::BuildCommandBufferSimple(VkCommandBuffer a_cmdBuff, VkImage a_targetImage, VkImageView a_targetImageView)
{
  ...
  // Gaussian blur
  {
    ...
    auto set = etna::create_descriptor_set(gaussianBlurInfo.getDescriptorLayoutId(0), {
        etna::Binding { 0, vk::DescriptorImageInfo { defaultSampler.get(), rawImage.getView({}), vk::ImageLayout::eGeneral } },
        etna::Binding { 1, vk::DescriptorImageInfo { defaultSampler.get(), blurredImage.getView({}), vk::ImageLayout::eGeneral } },
    });
    ...
    vkCmdBindDescriptorSets(a_cmdBuff, VK_PIPELINE_BIND_POINT_COMPUTE, gaussianBlurInfo.getPipelineLayout(), 0, 1, &vkSet, 0, VK_NULL_HANDLE);
  ...
  // Copy blurred image to target image
  ...
  vkCmdBlitImage(
    a_cmdBuff, blurredImage.get(), VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL, a_targetImage,
    VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &blitSpecs, VK_FILTER_NEAREST
  );
